...
public class AliyunOSSClientUtil {
     ...
     * @return
     */
    public String getImgUrl(String fileUrl,OSSClient ossClient) {
        if (!StringUtils.isEmpty(fileUrl)) {
            String[] split = fileUrl.split("/");
            return this.getUrl(FOLDER + split[split.length - 1],ossClient);
        }
        return null;
    }
    ...
    public static void main(String[] args) {
        ...
        //上传文件
        String files = "E:\\003.png,E:\\004.jpg,E:\\005.jpg";
        ...
        for (String filename : file) {
            ...
            logger.info("http://htaocar.oss-cn-hangzhou.aliyuncs.com/car/"+filess.getName());
            logger.info("http://htaocar.oss-cn-hangzhou.aliyuncs.com/car/"+filess.getName()+"?x-oss-process=style/car");
            //上传后的文件MD5数字唯一签名:40F4131427068E08451D37F02021473A
//            String url = getUrl(md5key, ossClient);
//            logger.info("上传图片的网络地址:"+ url);
